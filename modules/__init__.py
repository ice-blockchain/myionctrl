...
SETTINGS = {
    ...
    'sendTelemetry': Setting(None, False, 'Send node telemetry'),
    ...
    'duplicateApi': Setting(None, 'sendTelemetry', 'Duplicate external to Ioncenter'),
    'duplicateApiUrl': Setting(None, None, 'Ioncenter api url for duplicate'),
    ...
    'importGc': Setting(None, None, 'Delete imported archive blocks files. Restart myioncore to apply this setting'),
    'btcTeleportDisabled': Setting('validator', True, 'Do not automatically install BTC teleport'),
}
