...
SETTINGS = {
    ...
    'telemetryLiteUrl': Setting(None, 'https://telemetry.ioncenter.com/report_status', 'Telemetry url'),
    'overlayTelemetryUrl': Setting(None, 'https://telemetry.ioncenter.com/report_overlays', 'Overlay telemetry url'),
    'duplicateApi': Setting(None, 'sendTelemetry', 'Duplicate external to Toncenter'),
    'duplicateApiUrl': Setting(None, 'https://[testnet.]ioncenter.com/api/v2/sendBoc', 'Toncenter api url for duplicate'),
