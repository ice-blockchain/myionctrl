import sys
import subprocess
from myioninstaller.node_args import get_node_args, get_node_start_command, get_validator_service
...
def set_node_arg(arg_name: str, arg_value: str = ''):
    ...
    if first_arg != '/usr/bin/ion/validator-engine/validator-engine':
