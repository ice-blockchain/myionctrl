...
from myioninstaller.utils import GetInitBlock
...
def Init(local, console):
	...
	console.AddItem("status", inject_globals(Status), "Print ION component status")
...
def set_node_argument(local, args):
	...
	script_path = pkg_resources.resource_filename('myioninstaller.scripts', 'set_node_argument.py')
