...
from myioncore.utils import xhex2hex, ng2g
...
class MyIonCore():
	...
	def remove_proofs_from_complaint(self, input_file_name: str):
		...
		fift_script = pkg_resources.resource_filename('myioncore', 'complaints/remove-proofs-v2.fif')
	...
	def send_boc_ioncenter(self, file_path: str):
		...
		if network_name == 'testnet':
			default_url = 'https://testnet.ice.io/api/v2/sendBoc'
		elif network_name == 'mainnet':
			default_url = 'https://ice.io/api/v2/sendBoc'
		else:
			default_url = None
