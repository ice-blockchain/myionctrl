...
def Telemetry(local, ion):
    ...
    liteUrl_default = "https://telemetry.ioncenter.com/report_status"
...
def OverlayTelemetry(local, ion):
    ...
    # Send data to toncenter server
    overlayUrl_default = "https://telemetry.ioncenter.com/report_overlays"
...
def General(local):
    ...
    local.start_cycle(Domains, sec=600, args=(local, ion, ))
