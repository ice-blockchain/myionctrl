...
from myioncore.telemetry import GetMemoryInfo, GetSwapInfo, GetUname, GetValidatorProcessInfo, get_db_stats, get_cpu_name, is_host_virtual, get_validator_disk_name, get_pings_values
...
def General(local):
    ...
    local.start_cycle(gc_import, sec=600, args=(local, ion))
