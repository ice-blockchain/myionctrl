...
from myioncore.utils import parse_db_stats
...
def get_db_stats():
    ...
    rocksdb_stats_path = '/var/ion-work/db/db_stats.txt'
    celldb_stats_path = '/var/ion-work/db/celldb/db_stats.txt'
...
def get_pings_values():
    return {
        'beacon-eu-01.ioncenter.com': do_beacon_ping('beacon-eu-01.ioncenter.com', 5, 10),
        'beacon-apac-01.ioncenter.com': do_beacon_ping('beacon-apac-01.ioncenter.com', 5, 10)
    }


def get_validator_disk_name():
    process = subprocess.run("df -h /var/ion-work/ | sed -n '2 p' | awk '{print $1}'", stdin=subprocess.PIPE,
